...
<body background="images/mercaBella_22.png" style="background-repeat: no-repeat;">
    ...
    <section>
        <div class="container">
            <div class="row mt-5 mb-5">
                <div class="col-md-7 mx-auto">
                    <p class="display-5">TAMBIEN PUEDE INTERESARTE</p>
                </div>
            </div>
            <div class="row mt-5 mb-5">
                <div id="carousel-6">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-md-1 mx-auto">
                    <button id="btn-slick-6" class="btn bg-light text-center" style="color: orange; font-size: 12px; background-color: transparent;">
