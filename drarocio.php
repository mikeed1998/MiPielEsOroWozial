	...
	<section class="section">
		<div class="container-fluid">
					...
					<div class="row">
						<div class="card border-0 bg-warning">
							...
							<div class="card-body">
								...
								<p style="text-align: justify;">
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptatibus quia iure, nisi sunt, numquam facere ipsum natus earum velit dolorum necessitatibus incidunt ad facilis molestiae officiis unde reiciendis repellat aliquam voluptatum dolore fuga, ea. Totam fugit deleniti beatae culpa?
								</p>
								<p style="text-align: justify;">
				...
				<div class="col-md-6">
					...
					<div class="row">
						<div class="col mx-auto text-center">
							<img src="images/home_15.png" alt="" class="" width="40%" height="60%">
						</div>
					</div>
					<div class="row mx-auto text-center">
						<div class="col-md-4">
							<img src="images/Rocio_03.png" class="img-fluid">
						</div>
						<div class="col-md-4">
							<img src="images/Rocio_03.png" class="img-fluid">
						</div>
			...
			<div class="row mt-5 mb-5">
				<div class="col mx-auto text-center">
					<p class="display-5 text-center">NUESTRO MANIFIESTO</p>
				</div>
			</div>
			<div class="row mt-5 mb-5">
					...
					<div class="row">
						<div class="card border-0">
							...
							<div class="card-body" style="text-align: justify;">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Assumenda labore quod ea eius laborum earum corrupti corporis, delectus numquam nisi iste, pariatur nostrum nesciunt repellat eveniet, consequatur ipsam dolorem commodi, unde illo itaque. Explicabo optio animi cumque, quasi officia non.
							</div>
						</div>
					</div>
				</div>
