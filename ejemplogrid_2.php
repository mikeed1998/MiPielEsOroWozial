		...
		<div class="container">
			<div class="row">
				...
				<div class="col text-center">
					<img src="images/logo.png" alt="" class="img-fluid h-50">
				</div>
						...
						<div class="row mx-auto text-center border">
			                <div class="col-md-5">
			                    ...
			                    <div class="row mt-2 mb-5">
			                        <div class="col">
			                            <button id="btn-slick-4" class="btn bg-light text-center" style="color: orange; font-size: 12px; background-color: Transparent; border: none;">
			                ...
			                <div class="col-md-5">
			                    <div class="row mt-5">
			                        <div class="col-md-4 mx-auto">
			                            <h2 style="padding: 0; margin: 0;">CELULITIS</h2>
			                        </div>
			                    </div>
			                    <div class="row">
			                    ...
			                    <div class="row mb-3">
			                        <div class="col-md-4 mx-auto">
			                            <h4 style="padding: 0; margin: 0;">$800.00</h4>
			                        </div>
			                    </div>
			                    <div class="row">
			                        <div class="col">
			                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo vitae molestias fugit modi voluptatum. Est repellat provident mollitia a neque odit, numquam, quos perferendis hic eveniet, aut sint possimus inventore.</p>
			                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officiis ullam temporibus repellendus nemo in eius, aspernatur incidunt magnam asperiores, qui dolore vel quidem odit quos provident, quaerat fugiat alias eveniet rem quasi accusamus. Mollitia sed eveniet commodi necessitatibus laboriosam quam et impedit ipsa neque. Earum doloremque eum, explicabo unde dolorem.</p>
			                        </div>
			                    </div>
