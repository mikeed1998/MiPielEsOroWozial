		...
		<div class="container-fluid bg-warning" style="background-image: url('images/Contacto_03.png'); background-size: 450px; background-repeat: no-repeat; background-position: right top;">
			...
			<div class="row mt-2 mb-2 mx-auto">
				...
				<div class="col-md-2 mx-auto text-end">
					<input type="text" class="form-control bg-warning border border-dark" placeholder="NOMBRE: ">
				</div>
				<div class="col-md-2 mx-auto text-start">
					<input type="text" class="form-control bg-warning border border-dark" placeholder="WHATSAPP: ">
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row mt-2 mb-2 mx-auto">
				<div class="col-md-4"></div>
				<div class="col-md-2 mx-auto text-end">
					<input type="text" class="form-control bg-warning border border-dark" placeholder="TELEFONO: ">
				</div>
				<div class="col-md-2 mx-auto text-start">
					<input type="text" class="form-control bg-warning border border-dark" placeholder="CORREO: ">
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row mt-2 mb-2 mx-auto">
				<div class="col-md-4 mx-auto">
					<textarea class="form-control bg-warning border border-dark" style="height: 200px;" placeholder="MENSAJE: "></textarea>
				</div>
			</div>
	...
	<section>
		<div class="container">
			<div class="row mt-5 mb-3">
				<div class="col-md-4 mx-auto">
					<p class="display-5">ENCUENTRANOS</p>
				</div>
			</div>
			<div class="row mt-3 mb-5">
				<div class="md-12">
					<div class="col text-center">AVENIDAD LAPIZLAZULI 2074 INT 3</div>
					<div class="col text-center">RESIDENCIAL VICTORIA</div>
					<div class="col text-center">GUADALAJARA, JALISCO</div>
				</div>
			</div>
			<div class="row mt-3 mb-3">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d59726.325260510064!2d-103.35974389558793!3d20.673837004762593!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2smx!4v1660254201213!5m2!1ses-419!2smx" width="600" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</section>
